...
advantages:
  - name: "Boomerang Idol (Finder)"
    desc: "Ozzy holds this idol on Vatu. If Ozzy is voted out without playing it, it boomerangs back to Genevieve."
  - name: "Boomerang Idol (Finder — planted)"
    desc: "Genevieve found a new idol on Kalo's beach and secretly planted it in Rizo's bag on Cila. Rizo believes it's his. If Rizo is voted out without playing it, it returns to Genevieve."
alliances: "<strong>The most advantaged player in the game.</strong> Two active Boomerang Idol finder positions — one on Ozzy, one on Rizo — give her cross-tribal insurance no matter what happens. She's playing a long con with Rizo that could pay off massively at merge. Still on Kalo with Colby as her only original Vatu ally."
---
...
Genevieve stepped up as a strategic force on Vatu. She orchestrated a full bag search on Aubry, suspicious that she might have an idol (the search came up empty since the idol was already gifted). She solidified the core four alliance (Q, Colby, Stephenie, Genevieve) and helped recruit Rizo into their numbers. Vatu won immunity again.
